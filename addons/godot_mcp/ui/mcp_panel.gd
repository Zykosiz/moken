...
func _ready():
	...
	port_field = $VBoxContainer/ConfigPanel/HBoxContainer/PortField
	start_button = $VBoxContainer/ButtonPanel/HBoxContainer/StartButton
	stop_button = $VBoxContainer/ButtonPanel/HBoxContainer/StopButton
